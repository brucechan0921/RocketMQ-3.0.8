...
public class MessageStoreConfig {
    ...
    private String abortFile = System.getProperty("user.home") + File.separator + "store" + File.separator
            + "abort";
    // CommitLog每个文件大小 1G
    private int mapedFileSizeCommitLog = 10 * 1024 * 1024; // by chen.si 1024*1024*1024, modified for memeory lack
    ...
    private int maxHashSlotNum = 5000; // by chen.si: map for lack memory  5000000
    private int maxIndexNum = 5000 * 4; // by chen.si: map for lack memory  5000000 * 4
